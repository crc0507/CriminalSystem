...
//											System.out.println("duration=========="+duration);
											...
											Date startDate = effectiveDate.strToDate(timesArrayList.get(0).getStartTime());
											Date endDate = effectiveDate.strToDate(timesArrayList.get(0).getEndTime());
...
//								System.out.println("time:"+(1+1)+"----"+curNode.getId()+"--------tag"+tagNum+"嫌疑:"+closeRate);
								//计算第二层的亲密度
											...
											if(inRelationship2!=null) {
												...
												for(Map.Entry<String, Object> entry:inProperties2.entrySet()) {
													if(isValidDate(entry.getKey())) {
														...
														Date startDate2 = effectiveDate.strToDate(timesArrayList.get(0).getStartTime());
														Date endDate2 = effectiveDate.strToDate(timesArrayList.get(0).getEndTime());
...
//												System.out.println("time:"+(1+1)+"----"+curNode.getId()+"--------tag"+tagNum+"嫌疑:"+closeRate2);
//											}
//											System.out.println(totalDuration);
//											System.out.println(totalduration2);
